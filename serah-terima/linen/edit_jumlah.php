    ...
    <form action="" method="post">
      ...
      <table>
        <tr>
          ...
          <td>
            <select disabled required name="jenis_linen_id" id="jenis_linen">
        ...
        <tr>
          ...
          <td>
            <select disabled required name="spesifikasi_id" id="spesifikasi_linen">
        ...
        <tr>
          ...
          <td>
            <input required type="number" placeholder="Masukkan hitung lidi" id="hitung_lidi" name="hitung_lidi_laundry" value="<?= $item['hitung_lidi_laundry'] ?>">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <input required type="number" placeholder="Masukkan jumlah" id="jumlah" name="jumlah_laundry" value="<?= $item['jumlah_laundry'] ?>">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <textarea name="keterangan_laundry" id="keterangan" cols="30" rows="4" placeholder="Masukkan keterangan"><?= $item['keterangan_laundry'] ?></textarea>
          </td>
        </tr>
